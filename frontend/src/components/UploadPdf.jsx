...
// Api
import { uploadPdfFile } from "../api/api"; // Import the function to upload files
// Icons
...
const UploadPdf = () => {
  ...
  const handleFileUpload = async () => {
    try {
      ...
      // Log that the file has been passed to the uploadPdfFile function
      console.log("File passed to uploadPdfFile function:", response);

      // Set success message
      setIsSuccess(true);
      setMessage("File uploaded and copied successfully.");
    } catch (error) {
